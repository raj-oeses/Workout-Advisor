    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.day1:if(typeis.equals("Select The Type"))
                ...
                setContentView(R.layout.beginnerday1biceps);
            else if(typeis.equals("Intermediate"))
                setContentView(R.layout.intermediateday1biceps);
            else if(typeis.equals("Advance"))
                setContentView(R.layout.advanceday1biceps);
                break;
            ...
            case R.id.day2:if(typeis.equals("Select The Type"))
                ...
                setContentView(R.layout.beginnerday2biceps);
            else if(typeis.equals("Intermediate"))
                setContentView(R.layout.intermediateday2biceps);
            else if(typeis.equals("Advance"))
                setContentView(R.layout.advanceday2biceps);
                break;
        }
    }
}
