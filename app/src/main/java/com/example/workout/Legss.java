...
public class Legss extends AppCompatActivity implements View.OnClickListener{
    String typeis;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.day1:if(typeis.equals("Select The Type"))
                ...
                setContentView(R.layout.intermediateday1legs);
            else if(typeis.equals("Advance"))
                setContentView(R.layout.advanceday1legs);
                break;
            ...
            case R.id.day2:if(typeis.equals("Select The Type"))
                ...
                setContentView(R.layout.beginnerday2legs);
            else if(typeis.equals("Intermediate"))
                setContentView(R.layout.intermediateday2legs);
            else if(typeis.equals("Advance"))
                setContentView(R.layout.advanceday2legs);
                break;
